...
// distance resolution (0.5 mm/unit) and measurement precision have NOT been
// fully characterized. This code is provided in a "usable" state — it parses
// scans correctly, but treat all numbers as approximate pending calibration.
//
...
//   - distance scale is 0.5 mm/unit (not 0.25 mm/unit)
...
class LDS_DELTA_2C_115200 : public LDS {
  ...
  protected:
    ...
    struct meas_sample_t {
      uint8_t quality;
      uint16_t distance_mm_x4; // 2C: 0.5 mm per unit (empirical)
